...
import { FiCopy, FiCheck, FiTrash2, FiClock, FiX } from "react-icons/fi";
      ...
      setHistory((prev) => [
        {
          ...
          title:
            messages.find((m) => m.from === userName)?.text?.slice(0, 40) ||
            "New Chat",
          messages: [...messages],
        },
        ...prev,
...
const styles = {
  page: {
    ...
    alignItems: "center",
    background:
      "radial-gradient(circle at top left, #12254a 0%, #0f172a 30%, #111827 65%, #1e1b4b 100%)",
